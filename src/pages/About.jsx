    ...
    return (
        <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
            ...
            <div className="relative overflow-hidden bg-red-700 text-white">
                {/* Background pattern overlay - traditional Korean pattern inspired */}
                ...
                {/* Decorative elements */}
                <div className="absolute -top-16 -left-16 w-64 h-64 bg-yellow-500 rounded-full opacity-20"></div>
                <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-red-800 rounded-full opacity-20"></div>

                <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 relative z-10">
                    <div className="flex flex-col md:flex-row items-center">
                        {/* Taekwondo icon */}
                        <div className="mb-8 md:mb-0 md:mr-12">
                            <div className="w-24 h-24 md:w-32 md:h-32 bg-yellow-500 rounded-full flex items-center justify-center shadow-lg" >
                                <img
                                ...
                                <path d="M18 4L14 8L14 14L18 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M6 4L10 8L10 14L6 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12 6L12 13M12 13L9 16M12 13L15 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <div className="text-center md:text-left">
                            <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                                About <span className="text-yellow-400">Dojang</span>
                            </h1>
            ...
            <div className="max-w-6xl mx-auto px-6 py-16">
                {/* Introduction with belt-styled background */}
                <div className="mb-20 relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-red-600 via-yellow-500 to-red-600 transform -skew-y-2 rounded-lg opacity-10"></div>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-20">
                    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100 transform hover:-translate-y-1 hover:border-yellow-300">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100 transform hover:-translate-y-1 hover:border-red-300">
                        <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                            <svg className="w-8 h-8 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                            </svg>
                        </div>
                        <h2 className="text-2xl font-bold text-yellow-600 mb-4 text-center">Core Features</h2>
                        <ul className="space-y-3 text-gray-700">
                            <li className="flex items-center">
                                <span className="w-2 h-6 bg-gradient-to-b from-red-500 to-yellow-500 rounded-full mr-3"></span>
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100 transform hover:-translate-y-1 hover:border-yellow-300">
                        ...
                        <h2 className="text-2xl font-bold text-red-700 mb-4 text-center">Why Join Us?</h2>
                        <p className="text-gray-700">
                ...
                <div className="mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-red-700 mb-2">Meet Our Founders</h2>
                                    ...
                                    <div className="h-52 bg-gray-100 relative">
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white shadow-lg">
                                                <img src={`/api/placeholder/300/300`} alt={profile.name} className="w-full h-full object-cover" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="p-6 text-center">
                                        <div className={`inline-block px-4 py-1 ${index === 0 ? 'bg-red-100 text-red-700' :
                ...
                {/* Call to Action with traditional Korean design elements */}
                <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-8 md:p-12 text-white text-center relative overflow-hidden shadow-xl">
                    {/* Korean pattern-inspired decorative elements */}
                    <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[url('data:image/svg+xml;base64,')]"></div>

                    <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-500 rounded-full opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-yellow-500 rounded-full opacity-20 transform -translate-x-1/2 translate-y-1/2"></div>

                    <div className="relative z-10">
                        <h2 className="text-3xl font-bold mb-4">Be Part of the <span className="text-yellow-300">Dojang</span> Community</h2>
                        <p className="text-xl mb-8 max-w-2xl mx-auto">
                            Join us and contribute to a growing network of passionate martial artists.
                            Let's build a legacy together!
                        </p>
                        <button className="px-8 py-3 bg-yellow-500 text-red-800 rounded-lg font-medium text-lg hover:bg-yellow-400 transition-colors duration-300 shadow-md transform hover:scale-105">
                            Get Started
                        </button>
                    </div>
                </div>
            ...
            <div className="mt-20">
                {/* Belt stripe design */}
                <div className="h-6 bg-gradient-to-r from-red-700 via-yellow-500 to-red-700"></div>
